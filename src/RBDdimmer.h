...
#include <stdlib.h>
    ...
    #include "RBDmcuRenesas.h" //  Renesas platform support
#else 
    #error "This library only supports boards with an AVR, ESP32, ESP8266, SAMD, SAM, STM32F1/F4, or Renesas processor."
#endif
